 ...
 * @author Hwany 
 */
public class NettyClientBootstrapFactory implements INettyBootstrapFactory<Bootstrap> {

	private static final Logger logger = LoggerFactory.getLogger(NettyClientBootstrapFactory.class);
...
//	private EventLoopGroup  nioEventLoopGroup;	
	...
	public NettyClientBootstrapFactory(String workerThread, HashMap<ChannelOption<?>, Object> channelOptions, ChannelInitializer<?> channelInitializer) {
	 ...
	 * @param channelInitializer
	 */	
	public NettyClientBootstrapFactory(String workerThread, Class<? extends Channel> channelType, HashMap<ChannelOption<?>, Object> channelOptions, ChannelInitializer<?> channelInitializer) {
