 ...
 * @author Hwany 
 */
public class NettyWebClientBootstrapFactory implements INettyBootstrapFactory<Bootstrap> {

	private static final Logger logger = LoggerFactory.getLogger(NettyWebClientBootstrapFactory.class);
...
//	private EventLoopGroup  nioEventLoopGroup;	
	...
	public NettyWebClientBootstrapFactory(String workerThread, HashMap<ChannelOption<?>, Object> channelOptions, ChannelInitializer<?> channelInitializer) {
	 ...
	 * @param channelInitializer
	 */	
	public NettyWebClientBootstrapFactory(String workerThread, Class<? extends Channel> channelType, HashMap<ChannelOption<?>, Object> channelOptions, ChannelInitializer<?> channelInitializer) {
